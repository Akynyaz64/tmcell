...
import footer_bg from "../../../assets/img/bg/footer-bg.png";
import map_icon from "../../../assets/icons/map-marker.svg"
                                    ...
                                    <ul>
                                        <li className="media">
                                            <span className="widget-icon">
                                                <img src={map_icon} className="svg" alt="" />
                                            </span>
                                            <div className="media-body">217 Oguzhan köçesi, Aşgabat şäheri, 744000</div>
                                        </li>
                                        <li className="media">
                                            <span className="widget-icon">
                                                <img src={phone_icon} className="svg" alt="" />
                                            </span>
                                        ...
                                        <li className="media">
                                            <span className="widget-icon">
                                                <img src={mail_icon} className="svg" alt="" />
                                            </span>
                                            <div className="media-body">
