        ...
        !(function (t, N) {
            ...
            (j.color = function (t) {
                ...
                (j.hsl2rgb = function (t, e, r, i) {
                    var n, s, a;
                    return this.is(t, "object") && "h" in t && "s" in t && "l" in t && ((r = t.l), (e = t.s), (t = t.h)), (1 < t || 1 < e || 1 < r) && ((t /= 360), (e /= 100), (r /= 100)), (s = (a = 2 * e * (r < 0.5 ? r : 1 - r)) * (1 - S(((t = ((t *= 360) % 360) / 60) % 2) - 1))), (r = e = n = r - a / 2), st((r += [a, s, 0, 0, s, a][(t = ~~t)]), (e += [s, a, a, s, 0, 0][t]), (n += [0, 0, s, a, a, s][t]), i);
                }),
            ...
            (K.getElementByPoint = function (t, e) {
                ...
                (qt.glow = function (t) {
                    ...
                    for (var e = { width: ((t = t || {}).width || 10) + (+this.attr("stroke-width") || 1), fill: t.fill || !1, opacity: t.opacity || 0.5, offsetx: t.offsetx || 0, offsety: t.offsety || 0, color: t.color || "#000" }, r = e.width / 2, i = this.paper, n = i.set(), s = this.realPath || Z[this.type](this), s = this.matrix ? Q(s, this.matrix) : s, a = 1; a < 1 + r; a++) n.push(i.path(s).attr({ stroke: e.color, fill: e.fill ? e.color : "none", "stroke-linejoin": "round", "stroke-linecap": "round", "stroke-width": +((e.width / r) * a).toFixed(3), opacity: +(e.opacity / r).toFixed(3) }));
                    ...
                    if (j.vml) {
                        ...
                        function p(t, e) {
                            ...
                            if (
                                ...
                                "clip-rect" in e && (4 == (i = _(e["clip-rect"]).split(T)).length && ((i[2] = +i[2] + +i[0]), (i[3] = +i[3] + +i[1]), ((s = (n = h.clipRect || j._g.doc.createElement("div")).style).clip = j.format("rect({1}px {2}px {3}px {0}px)", i)), h.clipRect || ((s.position = "absolute"), (s.top = 0), (s.left = 0), (s.width = t.paper.width + "px"), (s.height = t.paper.height + "px"), h.parentNode.insertBefore(n, h), n.appendChild(h), (h.clipRect = n))), e["clip-rect"] || (h.clipRect && (h.clipRect.style.clip = "auto"))),
                                t.textpath && ((o = t.textpath.style), e.font && (o.font = e.font), e["font-family"] && (o.fontFamily = '"' + e["font-family"].split(",")[0].replace(/^['"]+|['"]+$/g, "") + '"'), e["font-size"] && (o.fontSize = e["font-size"]), e["font-weight"] && (o.fontWeight = e["font-weight"]), e["font-style"] && (o.fontStyle = e["font-style"])),
                                "arrow-start" in e && F(d, e["arrow-start"]),
                                "arrow-end" in e && F(d, e["arrow-end"], 1),
                                (null == e.opacity && null == e["stroke-width"] && null == e.fill && null == e.src && null == e.stroke && null == e["stroke-width"] && null == e["stroke-opacity"] && null == e["fill-opacity"] && null == e["stroke-dasharray"] && null == e["stroke-miterlimit"] && null == e["stroke-linejoin"] && null == e["stroke-linecap"]) ||
                                    ...
                                    e["stroke-dasharray"] && ((l = { "-": "shortdash", ".": "shortdot", "-.": "shortdashdot", "-..": "shortdashdotdot", ". ": "dot", "- ": "dash", "--": "longdash", "- .": "dashdot", "--.": "longdashdot", "--..": "longdashdotdot" }), (g.dashstyle = l[b](e["stroke-dasharray"]) ? l[e["stroke-dasharray"]] : "")),
                                    a && h.appendChild(g)),
                                "text" == d.type)
                            ) {
...
!(function (e) {
    ...
    var r = (function () {
        ...
        d = {
            ...
            mapinfo: s,
            load: f,
            hooks: r.clone({ over_state: !1, over_region: !1, over_location: !1, out_state: !1, out_region: !1, out_location: !1, click_state: !1, click_region: !1, click_location: !1, close_popup: !1, zoomable_click_state: !1, zoomable_click_region: !1, complete: !1, refresh_complete: !1, zooming_complete: !1, back: !1, ready: !1, click_xy: !1 }),
            plugin_hooks: r.clone({ over_state: [], over_region: [], over_location: [], out_state: [], out_region: [], out_location: [], click_state: [], click_region: [], click_location: [], preclick_state: [], preclick_region: [], preclick_location: [], close_popup: [], zoomable_click_state: [], zoomable_click_region: [], complete: [], refresh_complete: [], zooming_complete: [], back: [], ready: [], click_xy: [] }),
            copy: function () {
    ...
    function f() {
        ...
        function tA() {
            (E = !!a.background_image_url && "no" != a.background_image_url && a.background_image_url), (C = !!a.background_image_bbox && a.background_image_bbox), (W = "yes" == a.background_transparent ? 0 : 1), (Y = a.label_size ? a.label_size : 22), (Q = a.label_color ? a.label_color : "#ffffff"), (X = "yes" == a.url_new_tab), (Z = a.location_opacity ? a.location_opacity : 1), (U = "yes" == a.js_hooks), (G = a.border_size ? a.border_size : 1.5), (J = a.popup_color ? a.popup_color : "#ffffff"), (P = a.popup_orientation ? a.popup_orientation : "auto"), (I = a.popup_centered ? a.popup_centered : "auto"), (ee = a.popup_opacity ? a.popup_opacity : 0.9), (et = a.popup_shadow > -1 ? a.popup_shadow : 1), (eo = a.popup_corners ? a.popup_corners : 5), (ei = "yes" == a.popup_nocss), (K = !!a.popup_maxwidth && a.popup_maxwidth), (en = a.popup_font ? a.popup_font : "12px/1.5 Verdana, Arial, Helvetica, sans-serif"), (V = "no" != a.zoom_out_incrementally), (q = a.adjacent_opacity ? a.adjacent_opacity : 0.3), (T = a.zoom_time ? a.zoom_time : 0.5), (B = a.zoom_increment ? a.zoom_increment : 2), (S = "no" != a.zoom_mobile), (D = a.fade_time ? 1e3 * a.fade_time : 200), (H = t5.labels), (F = a.custom_shapes ? a.custom_shapes : {}), (L = !!a.initial_back && "no" != a.initial_back && a.initial_back), (R = "yes" == a.hide_eastern_labels), (N = a.link_text ? a.link_text : "View Website"), (O = !!a.order_number && a.order_number), (j = a.zoom_percentage ? a.zoom_percentage : 0.99);
        }
        function tE(e) {
        ...
        function tN() {
            (eJ = t5.locations),
                ...
                !(function () {
                    var e = {};
                    if (((e.color = !1), (e.hover_color = !1), (e.opacity = a.region_opacity ? a.region_opacity : 1), (e.hover_opacity = a.region_hover_opacity ? a.region_hover_opacity : 0.6), (e.url = !1), (e.description = !1), (e.description_mobile = !1), (e.inactive = !1), (e.zoomable = !0), (e.hide_name = "yes" == a.region_hide_name), (e.popup = a.region_popups ? a.region_popups : em), (e.cascade = "yes" == a.region_cascade_all), (e.zoom_percentage = j), (e.x = !1), (e.y = !1), (e.x2 = !1), (e.y2 = !1), z)) for (var t in z) for (var o = 0; o < z[t].states.length; o++) eU[z[t].states[o]] = t;
        ...
        function tH(e, t) {
            ...
            function n(e) {
                var t,
                    ...
                    p = m / 5,
                    d = (l - c) / 5,
                    f = [0.8487, 0.84751182, 0.84479598, 0.840213, 0.83359314, 0.8257851, 0.814752, 0.80006949, 0.78216192, 0.76060494, 0.73658673, 0.7086645, 0.67777182, 0.64475739, 0.60987582, 0.57134484, 0.52729731, 0.48562614, 0.45167814],
        ...
        function o4(n) {
            ...
            if (
                ...
                (o = (t = "default" != a.images_directory && a.images_directory) || T.substring(0, T.lastIndexOf("/usmap.js") + 1) + "map_images/"),
                !e && S && (e = o + S),
                (er = "VML" == Raphael.type),
